...
public class Entreprise {
    ...
    public MachineMatierePremiere machineDecoupage;
    public MachineProduitFini machineBroyage;
    public MachineProduitFini machineCuisson;
    public MachineProduitFini machineEmballage;
    public Cours cours;
    ...
    private void InitMachines() {
        ...
        machineDecoupage = new MachineMatierePremiere("DECOUPAGE", capaciteDecoupage);
        machineBroyage= new MachineProduitFini("BROYAGE", capaciteBroyage);
        machineCuisson= new MachineProduitFini("CUISSON", capaciteCuisson);
         machineEmballage= new MachineProduitFini("EMBALLAGE", capaciteEmballage);
